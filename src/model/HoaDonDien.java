...
public class HoaDonDien extends HoaDon {
	...
	public HoaDonDien(LocalDate ngayGuiHD, LocalDate ngayHetHan, String maKH, double soKgDien) {
	...
	public String inHoaDon() {
	    ...
	    stringBuilder.append("Tổng tiền phải thanh toán: ").append(soTien).append(" VNĐ\n");
